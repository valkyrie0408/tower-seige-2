...
function draw() {
  ...
  rectMode(CENTER);
  ground.display();
  box1.display("purple", "pink");
  box2.display("red", "pink");
  box3.display("purple", "pink");
  box4.display("red", "pink");
  box5.display("purple", "pink");
  box6.display("indigo", "pink");
  box7.display("green", "pink");
  box8.display("indigo", "pink");
  box9.display("green", "pink");
  box10.display("indigo", "pink");
  box11.display("green", "pink");
  box12.display("indigo", "pink");
  box13.display("lilac", "pink");
  box14.display("lilac", "pink");
